...
function SummaryCard({
  ...
  return (
    <div className="rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3">
      ...
      <p className="mt-1 text-lg font-black text-[#080A0F]">{value}</p>
    </div>
  );
}
      ...
      <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-3">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#C9922A]/10">
              <BarChart3 size={16} className="text-[#C9922A]" />
            </span>
            <div>
              <p className="font-black text-[#080A0F]">Resumen local</p>
          ...
          <button
            ...
            className="self-start rounded-xl border border-slate-200 px-3 py-1.5 text-xs font-semibold text-neutral-500 transition-colors hover:border-red-200 hover:text-red-500"
          >
        ...
        <div className="grid gap-2 sm:grid-cols-4">
          ...
          <div className="rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3">
            ...
            {topTemplate ? (
              <>
                <p className="mt-1 line-clamp-1 text-sm font-black text-[#080A0F]">
              ...
              <p className="mt-2 text-xs text-neutral-400">Sin datos aún</p>
            )}
          </div>
        </div>
      </div>
