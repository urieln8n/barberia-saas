    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-black tracking-tight text-[#0D0D0D]">Tareas</h1>
          ...
          return (
            <button
              ...
              className={`rounded-full px-3 py-1.5 text-xs font-semibold transition-colors ${
                filter === key ? "bg-[#0D0D0D] text-white" : "border border-neutral-200 bg-white text-neutral-600 hover:border-neutral-300"
              }`}
            >
              {label} ({count})
            </button>
            ...
            return (
              <div
                ...
                className={`flex items-start gap-4 rounded-2xl border bg-white p-4 shadow-sm transition-opacity ${
                  done ? "opacity-60 border-neutral-200" : "border-[#E5E2D9]"
                }`}
              >
                {/* Toggle */}
                <button
                  ...
                  className="mt-0.5 shrink-0 text-neutral-400 transition-colors hover:text-[#0D0D0D] disabled:opacity-40"
                >
                  {done
                ...
                <div className="flex-1 min-w-0">
                  <p className={`font-bold text-[#0D0D0D] ${done ? "line-through text-neutral-400" : ""}`}>
                    {task.title}
                  </p>
                  {task.description && (
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    ...
                    {related && (
                      <span className="rounded-full bg-[#F5F2EA] px-2 py-0.5 text-[11px] font-semibold text-neutral-500">
                        {related}
                      </span>
                    )}
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-lg overflow-hidden rounded-3xl bg-white shadow-2xl">
            ...
            <div className="max-h-[90vh] overflow-y-auto p-8">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#C89B3C]">Tareas</p>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm outline-none focus:border-[#C89B3C]"
                      >
