...
export async function GET(req: NextRequest) {
  // Verificación de seguridad — CRON_SECRET debe estar configurado en producción.
  // Si no está definido el endpoint queda abierto, por eso se rechaza la petición.
