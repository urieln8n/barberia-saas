...
BEGIN
  ...
  IF p_client_id IS NOT NULL AND NOT EXISTS (
    ...
    RAISE EXCEPTION 'El cliente no pertenece a esta barberia.';
  END IF;
  ...
  IF p_barber_id IS NOT NULL AND NOT EXISTS (
    ...
    RAISE EXCEPTION 'El barbero no pertenece a esta barberia.';
  END IF;
  ...
  IF p_appointment_id IS NOT NULL AND NOT EXISTS (
    ...
    RAISE EXCEPTION 'La reserva no pertenece a esta barberia.';
  END IF;
  ...
  IF p_cash_session_id IS NOT NULL AND v_total > 0 THEN
...
BEGIN
  ...
  IF v_item.cash_session_id IS NOT NULL AND v_item.total_sale_price > 0 THEN
    INSERT INTO public.cash_movements (
      barbershop_id,
      cash_session_id,
      appointment_id,
