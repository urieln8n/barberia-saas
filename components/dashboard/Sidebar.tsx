    ...
    () => [
      {
        ...
        items: [
          ...
          { icon: CalendarDays,  title: "Agenda",          description: "Calendario y disponibilidad",   href: "/dashboard/agenda",    notification: pendingAppts },
          { icon: ClipboardList, title: "Reservas",        description: "Lista y pipeline de citas",     href: "/dashboard/reservas"                              },
      ...
      },
      {
        ...
        items: [
          ...
          { icon: Scissors, title: "Barberos",  description: "Equipo y rendimiento",            href: "/dashboard/barberos"  },
          { icon: Tag,      title: "Servicios", description: "Catálogo de servicios y precios", href: "/dashboard/servicios" },
        ],
      },
      {
        section: "Crecimiento",
        items: [
          ...
          { icon: BarChart2, title: "Estadísticas", description: "Métricas y rendimiento",          href: "/dashboard/estadisticas"                                                       },
        ],
      },
      {
        section: "Cuenta",
        items: [
          { icon: Wallet,   title: "Finanzas",       description: "Ingresos, gastos y pagos",              href: "/dashboard/finanzas"                                                                     },
